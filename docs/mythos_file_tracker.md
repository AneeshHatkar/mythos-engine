...
### `backend/app/engines/deep_world/architecture_built_environment_engine.py`
...
### `backend/app/engines/deep_world/civilization_life_engine.py`
...
- Line count: 166
- Imports:
  - `backend.app.engines.deep_world.architecture_built_environment_engine`
...
- Line count: 168
- Imports:
  - `backend.app.engines.deep_world.civilization_life_engine`
  - `backend.app.engines.deep_world.country_political_unit_system`
